(function ($) {
    ...
    $(document).ready(function () {
        $(".customizer-color li").on("click", function () {
            ...
            $("#color").attr("href", baseUrl + "/public/assets/css/" + color + ".css");
